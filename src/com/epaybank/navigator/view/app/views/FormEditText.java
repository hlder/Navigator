package com.epaybank.navigator.view.app.views;
...
public class FormEditText extends EditText implements  OnFocusChangeListener{ 
	/**
	 * 删除按钮的引用
	 */
 ...
 */
	private void init() { 
		...
		if (mClearDrawable == null) { 
			mClearDrawable = getResources().getDrawable(R.drawable.img_delete_normal); 
		} 
